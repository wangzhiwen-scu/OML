...
from training.train_models.csmri_ei_bezier import ModelSet as OursModel
...
def test():
    ...
    args.supervised_dataset_name = 'ixi_t2_periodic_slight'
    ourtta = 'ixi_pd_periodic_slight'
