...
def process_data(df):
    ...
    key_order = ['T1ST2', 'T1MT2', 'T1SPD', 'T1MPD', \
                 'T2ST1', 'T2MT1', 'T2SPD', 'T2MPD', \
                 'PDST1', 'PDMT1', 'PDST2', 'PDMT2',  ]
...
if __name__ == "__main__":
    ...
    tab1_a = {
                ...
                "T1ST2": './results/fig2a1/MR_ART_Axial_None20230424-125428.xlsx',
                "T1MT2": './results/fig2a2/MR_ART_Axial_None20230424-135808.xlsx',
                "T1SPD": './results/fig2a3/MR_ART_Axial_None20230424-131421.xlsx',
                "T1MPD": './results/fig2a4/MR_ART_Axial_None20230424-140726.xlsx',

                "T2ST1": './results/fig2a5/MR_ART_Axial_None20230424-154915.xlsx',
                "T2MT1": './results/fig2a6/MR_ART_Axial_None20230424-155508.xlsx',
                "T2SPD": './results/fig2a7/MR_ART_Axial_None20230424-160349.xlsx',
                "T2MPD": './results/fig2a8/MR_ART_Axial_None20230424-161236.xlsx',

                "PDST1": './results/fig2a9/MR_ART_Axial_None20230424-161827.xlsx',
                "PDMT1": './results/fig2a10/MR_ART_Axial_None20230424-162406.xlsx',
                "PDST2": './results/fig2a11/MR_ART_Axial_None20230424-163255.xlsx',
                "PDMT2": './results/fig2a12/MR_ART_Axial_None20230424-164103.xlsx',

    }

    name = conditional_filename + 'tab2at1'
    pdf_or_png = 'png'
