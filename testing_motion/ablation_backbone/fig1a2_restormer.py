...
from training.train_models.ACCS_csmri_and_ei_tvloss_prior_restormer import ModelSet as OursModel
...
def test():
    ...
    with torch.no_grad():
        for x_iter in dataloader:
            ...
            get_seg_oasis1_main_map(args, imgs, NUM_SLICE, df, data_name, shotname, namespace, dpi=300, oneline=True) # for one line.
