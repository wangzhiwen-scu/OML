...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/ablation/ablation4_backbone/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "Linear": './results/ablation/ablation4_backbone/ixi_t1_linear_moderate_Axial_None20230625-104921.xlsx',
                "Nonlinear": './results/ablation/ablation4_backbone/ixi_t1_nonlinear_moderate_Axial_None20230625-105247.xlsx',
                "Sudden": './results/ablation/ablation4_backbone/ixi_t1_sudden_moderate_Axial_None20230625-105613.xlsx',
                "Single-shot": './results/ablation/ablation4_backbone/ixi_t1_singleshot_moderate_Axial_None20230625-105940.xlsx',
                "RL": './results/ablation/ablation4_backbone/ixi_t1_periodic_slight_rl_Axial_None20230625-110307.xlsx',
                "Moderate": './results/ablation/ablation4_backbone/ixi_t1_periodic_moderate_Axial_None20230625-110634.xlsx',
                "Heavy": './results/ablation/ablation4_backbone/ixi_t1_periodic_heavy_Axial_None20230625-111000.xlsx',
    }

    keys_list = ['unet', 'restormer', 'stripformer', 'mstpp', 'our']
