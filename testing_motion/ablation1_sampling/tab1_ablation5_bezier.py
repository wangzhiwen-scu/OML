...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/ablation/ablation5_bezier/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "t2_slight": './results/ablation/ablation5_bezier/ixi_t2_periodic_slight_Axial_None20230625-123418.xlsx',
                "t2_moderate": './results/ablation/ablation5_bezier/ixi_t2_periodic_moderate_Axial_None20230625-123539.xlsx',
                "pd_slight": './results/ablation/ablation5_bezier/ixi_pd_periodic_slight_Axial_None20230625-123659.xlsx',
                "pd_moderate": './results/ablation/ablation5_bezier/ixi_pd_periodic_moderate_Axial_None20230625-123820.xlsx',
    }

    keys_list = ['withbezier', 'withoutbezier']
