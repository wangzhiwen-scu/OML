...
def process_data(df, keys_list):
    ...
    # key_order = ['t2_slight', 't2_moderate', 'pd_slight', 'pd_moderate']
...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/ablation/ablation6_vggloss/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "Linear": './results/ablation/ablation6_vggloss/ixi_t1_linear_moderate_Axial_None20230625-130544.xlsx',
                "Nonlinear": './results/ablation/ablation6_vggloss/ixi_t1_nonlinear_moderate_Axial_None20230625-130723.xlsx',
                "Sudden": './results/ablation/ablation6_vggloss/ixi_t1_sudden_moderate_Axial_None20230625-130903.xlsx',
                "Single-shot": './results/ablation/ablation6_vggloss/ixi_t1_singleshot_moderate_Axial_None20230625-131043.xlsx',
                "RL": './results/ablation/ablation6_vggloss/ixi_t1_periodic_slight_rl_Axial_None20230625-131224.xlsx',
                "Moderate": './results/ablation/ablation6_vggloss/ixi_t1_periodic_moderate_Axial_None20230625-131403.xlsx',
                "Heavy": './results/ablation/ablation6_vggloss/ixi_t1_periodic_heavy_Axial_None20230625-131543.xlsx',
    }


    keys_list = ['vgg0', 'vgg3', 'vgg4', 'our']
