...
noisy_img = torch.tensor(noisy_img).view(1, 1, 256, 256).cuda()
clean_img = torch.tensor(clean_img).view(1, 1, 256, 256).cuda()
...
ax[0].imshow(np.clip(img0, 0.42, 0.62), cmap='gray')
ax[0].set_title('Noisy Img')

ax[1].imshow(np.clip(img1, 0.42, 0.62), cmap='gray')
ax[1].set_title('First downsampled')

ax[2].imshow(np.clip(img2, 0.42, 0.62), cmap='gray')
...
ax[0].imshow(np.clip(clean, 0.42, 0.62), cmap='gray')
ax[0].set_xticks([])
ax[0].set_yticks([])
ax[0].set_title('Ground Truth')

ax[1].imshow(np.clip(noisy, 0.42, 0.62), cmap='gray')
ax[1].set_xticks([])
ax[1].set_yticks([])
...
ax[2].imshow(np.clip(denoised, 0.42, 0.62), cmap='gray')
ax[2].set_xticks([])
ax[2].set_yticks([])
