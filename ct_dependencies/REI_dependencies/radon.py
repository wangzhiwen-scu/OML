...
from ct_dependencies.REI_dependencies.filters import RampFilter
from ct_dependencies.REI_dependencies.rei_utils import PI, SQRT2, deg2rad, affine_grid, grid_sample
...
# if __name__ == '__main__':
    ...
    # plotter.image('org', 1, img)
    # plotter.image('sino', 1, sino)
    # plotter.image('reco', 1, reco)
#
