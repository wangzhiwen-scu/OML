...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        training_save_path = 'model_zoo/exp1/fastmri_brain_t1_MR_ART_our_s1_train_fista.py_None.pth'
    ...
    def _validate(self, epoch, val_loader):
        ...
        with torch.no_grad():
            ...
            for index_val, (still_test, withmotion_test, _shotname) in val_loop: #  增加GPU 利用率
                ...
                x_test_rec, _temp1, _temp2 = self.model(x_test, out_test['batch_trajectories'])
