...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        self.ckpt = './model_zoo/exp1/dftlw_{}_{}_{}_{}.pth'.format(args.supervised_dataset_name, args.unsupervised_dataset_name, module, str(args.headmotion))
...
class Trainer:
    ...
    def train(self):
        ...
        for epoch in range(1, self.num_epochs+1):
            ...
            self._run_epoch_simumri(epoch, dataloader_sup)
    ...
    def _run_epoch_simumri(self, epoch, dataloader):
        step = 0
        epoch_loss = 0
