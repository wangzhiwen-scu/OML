...
class Trainer:
    ...
    def train(self):
        ...
        for epoch in range(1, self.num_epochs+1):
            ...
            self._run_epoch_ssid(epoch, dataloader_sup)
    ...
    def _run_epoch_ssid(self, epoch, dataloader):
        step = 0
        epoch_loss = 0
        ...
        for index, (still, with_motion, _shotname) in loop:
            ...
            out2 = self.sample_net(x_train)
            x_train2 = out2['complex_abs']
            y_train = self.model(x_train2)
