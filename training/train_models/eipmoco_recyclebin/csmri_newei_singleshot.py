...
from layers.mask_layer import Hand_Tailed_Mask_Layer, Hand_Tailed_Mask_Singleshot_Layer
...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        self.sample_net = Hand_Tailed_Mask_Singleshot_Layer(0.33, 'cartesian', (240, 240), resize_size=[240,240]).to(device, dtype=torch.float)
        # self.model = Unet().to(device, dtype=torch.float)
