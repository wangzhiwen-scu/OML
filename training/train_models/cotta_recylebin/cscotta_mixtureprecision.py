...
# import torch.cuda.amp import GradScaler 
    ...
    def _run_epoch_rotcsmri(self, epoch, dataloader):
        ...
        for index, (still, with_motion, _shotname) in loop:
            ...
            if step == 1:
                ...
                self.plotter.image('gt_r', epoch, rotate_y_train)
                self.plotter.image('zf_r', epoch, x_train)
                self.plotter.image('est_r', epoch, x_train_rec)
