...
from model_backbones.fista_net import FISTANetPlus, fista_net_loss_l1
...
class Trainer:
    ...
    def _run_epoch_csmri(self, epoch, dataloader):
        ...
        for index, (still, with_motion, _shotname) in loop:
            ...
            output = self.model(x_train, out['batch_trajectories'])
            x_train_rec, layers_sym, layers_st = output
            loss = fista_net_loss_l1(x_train_rec, x_train, layers_sym, layers_st)
