...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        train_module = 'tta_stage1.py'
        training_save_path = './model_zoo/ablation_mri_{}/{}_{}_{}.pth'.format(args.shift, args.pretrain_dataset, args.supervised_dataset_name, train_module)
        # 35, 92
...
class Trainer:
    ...
    def train(self):
        ...
        # import csv
        # # Save the PSNR values into a CSV file
        # with open('./model_zoo/ablation_mri_anatomy/psnr_values_wometa.csv', 'w', newline='') as csvfile:
        #     csvwriter = csv.writer(csvfile, delimiter=',')
            
        #     # Write header
        #     csvwriter.writerow(['Step', 'Model 1 PSNR'])
            
        #     for i in range(len(self.psnr_csv)):
        #         csvwriter.writerow([i+1, self.psnr_csv[i]])
