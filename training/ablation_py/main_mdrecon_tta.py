...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        self.ckpt = './model_zoo/ablation_mri_{}/{}_{}_{}.pth'.format(args.shift, args.pretrain_dataset, args.supervised_dataset_name, module)
        ...
        training_save_path = './model_zoo/ablation_mri_anatomy/fastmri_knee_pd_fastmri_brain_t2_main_mdrecon.py.pth'
