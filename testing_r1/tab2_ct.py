...
def process_data(df):
    ...
    method_order = ['ZF', 'EI', 'LEARN', 'TTT', 'MeteInvNet', 'Ours']

    key_order = ['Anatomy Shift', 'Dataset Shift', 'Ratio Shift']
...
def process_data_withwarning(df):
    ...
    # Define custom orders
    method_order = ['ZF', 'EI', 'LEARN', 'TTT', 'Ours']
...
if __name__ == "__main__":
    ...
    tab1_a = {
                ...
                "Anatomy Shift": 'results/fig2_ct_r1/anatomy/20240629-201618.xlsx',
                "Dataset Shift": 'results/fig2_ct_r1/dataset/20240629-204539.xlsx',
                "Ratio Shift": 'results/fig2_ct_r1/n_views/20240629-210149.xlsx',

    }

    name = conditional_filename
    pdf_or_png = 'png'
