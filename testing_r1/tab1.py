...
def change_key_name(dict):
    ...
    # new_keys = ['Baseline','CS-MTL','MDReconNet', 'LOUPE', 'SemuNet']
...
def process_data(df):
    ...
    method_order = ['ZF', 'EI', 'MDReconNet', 'TTT', 'Ours']

    key_order = ['Anatomy Shift', 'Dataset Shift', 'Modality Shift', 'Ratio Shift']
...
if __name__ == "__main__":
    ...
    tab1_a = {
                ...
                "Anatomy Shift": './results/fig1_mri/anatomy/20231025-180751.xlsx',
                "Dataset Shift": './results/fig1_mri/dataset/20231026-102840.xlsx',
                "Modality Shift": './results/fig1_mri/modality/20231026-104138.xlsx',
                "Ratio Shift": './results/fig1_mri/ratio/20231027-224153.xlsx',
