...
# https://github.com/advimman/lama/blob/7dee0e4a3cf5f73f86a820674bf471454f52b74f/saicinpainting/training/modules/ffc.py
...
from layers.lama_layers import get_activation, BaseDiscriminator
from layers.lama_layers import LearnableSpatialTransformWrapper
from layers.lama_layers import SELayer
...
class FourierUnit(nn.Module):
    ...
    def forward(self, x):
        ...
        # output = torch.irfft(ffted, s=ifft_shape_slice, dim=fft_dim, norm=self.fft_norm)
...
if __name__ == "__main__":  
    ...
    net = FFCResNetGenerator(1, 1, init_conv_kwargs=y["init_conv_kwargs"], downsample_conv_kwargs=y["downsample_conv_kwargs"], 
