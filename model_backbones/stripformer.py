# https://github.com/pp00704831/Stripformer-ECCV-2022-/blob/main/models/Stripformer.py
...
class Embeddings_output(nn.Module):
    def __init__(self, out_c):
        ...
        self.de_layer1_1 = nn.Sequential(
            nn.Conv2d(64, out_c, kernel_size=3, padding=1),
            self.activation
        )
...
class Stripformer(nn.Module):
    def __init__(self):
        ...
        self.encoder = Embeddings(in_c=1)
        head_num = 5
        dim = 320
        ...
        self.decoder = Embeddings_output(out_c=1)
