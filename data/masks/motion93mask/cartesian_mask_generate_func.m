function [] = cartesian_mask_generate_func(num)
Num_fixed=100;   %中心区域行数 1%=1+2; 5% = 8+5, 10% = 14+10, 15%=24+12, 20% = 
Num_Ran=123;     %其他区域随机行数
M=240; 
...
title('平行线采样模板')
%  保存
path = strcat('cartesian_240_240_93_',string(num));
save(path)
end
