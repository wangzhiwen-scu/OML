...
if __name__ == "__main__":
    ...
    dataset_sup = CT_dataset(dataset_name='mayo', test=False)
    ...
    n_views = 140
    options =  [n_views, 512, 256, 256, 0.006641, 0.0072, 0.0,  2*np.pi/n_views, 5, 2.5, 0] # 💎 512
    # options =  [60, 736, 256, 256, 0.006641, 0.012858, 0, 0.104719, 5.95, 4.906, 0, 0] # 💎 512
...
#     const scalar_t* __restrict__ binshift)
    ...
    # for x in dataloader_sup:400
        ...
        # fbpdata = ctlib_v2.backprojection(proj, options)
        ...
        # ! update 2023/12/8, correct
        # https://github.com/xiawj-hub/MAGIC/blob/master/main.py, 和ctlib 很像，但又差不多。